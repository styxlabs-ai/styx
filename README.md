...
Styx is built on leading compliance and identity infrastructure, including Chainlink's [Automated Compliance Engine (ACE)](https://chain.link/use-cases/compliance) and the [Chainlink Runtime Environment (CRE)](https://docs.chain.link/chainlink-functions), as well as GLEIF's verifiable Legal Entity Identifier ([vLEI](https://www.gleif.org/en/vlei/introducing-the-verifiable-lei-vlei)) standard.
